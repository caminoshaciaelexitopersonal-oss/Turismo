...
async def route_llm_request(prompt: str, conversation_history: List[Dict[str, str]], user) -> str:
    ...
    # 1. Obtener la configuración del usuario de forma asíncrona
    try:
        ...
        print(f"Advertencia: No se pudo obtener la configuración LLM del usuario. Usando router del sistema. Error: {e}")

    # 2. Si no hay config personalizada o falla, usar el router híbrido del sistema
