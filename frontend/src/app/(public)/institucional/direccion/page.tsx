...
// Componente reutilizado para renderizar una sección de contenido
...
export default async function DireccionPage() {
  try {
    ...
    const pagina = await getPaginaInstitucional('direccion-de-turismo');
    ...
    return (
      <div className="font-sans">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <ContentSection title="Políticas Locales de Turismo" content={pagina.politicas_locales} />
          <ContentSection title="Convenios y Asociaciones" content={pagina.convenios_asociaciones} />
          <ContentSection title="Informes de Resultados" content={pagina.informes_resultados} />
        </main>
      </div>
    );
  } catch {
    ...
    return (
      <div className="text-center py-20">
        ...
        <p className="mt-4 text-gray-600">
          ...
          <code className="bg-red-100 text-red-800 p-1 rounded mx-1">direccion-de-turismo</code>
